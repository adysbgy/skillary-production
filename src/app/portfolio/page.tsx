...
export const metadata: Metadata = {
  title: "Portofolio Pengalaman Pelatihan",
  description: "Lihat arsip pengalaman pelatihan Allman yang menjadi salah satu fondasi pengembangan Skillary dalam data, infografis, dashboard, presentasi bisnis, dan visual communication.",
};
      ...
      <section className="relative overflow-hidden bg-[#FFFDF9] py-20 lg:py-28" style={{ borderBottom: '1.5px solid rgb(240, 217, 200)' }}>
        ...
        <Container className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl font-bold leading-tight tracking-tight sm:text-5xl text-[#0F172A] mb-6">
            Portofolio Pengalaman Pelatihan
          </h1>
          ...
          <p className="text-sm text-[#94A3B8] italic max-w-2xl mx-auto">
