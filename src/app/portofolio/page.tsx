...
import { legacyServiceCatalog, publicPortfolioCards, publicPortfolioMetrics } from "@/lib/legacy-portfolio";
...
export default function PortfolioPage() {
  const metrics = publicPortfolioMetrics;
      ...
      <section className="py-16 lg:py-20 bg-white" style={{ borderBottom: '1.5px solid rgb(240, 217, 200)' }}>
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            ...
            <div className="text-center p-6 bg-[#FFFDF9] rounded-2xl" style={{ border: '1.5px solid rgb(240, 217, 200)' }}>
              <p className="text-3xl font-extrabold text-[#0F172A] tracking-tight">{metrics.documentedPrograms}</p>
              <p className="text-xs text-[#64748B] mt-1 font-medium">Dokumentasi Terkurasi</p>
            </div>
            <div className="text-center p-6 bg-[#FFFDF9] rounded-2xl" style={{ border: '1.5px solid rgb(240, 217, 200)' }}>
              <p className="text-3xl font-extrabold text-[#0F172A] tracking-tight">{metrics.documentedOrganizations}</p>
              <p className="text-xs text-[#64748B] mt-1 font-medium">Organisasi dalam Arsip</p>
            </div>
            <div className="text-center p-6 bg-[#FFFDF9] rounded-2xl" style={{ border: '1.5px solid rgb(240, 217, 200)' }}>
              <p className="text-3xl font-extrabold text-[#0F172A] tracking-tight">{metrics.documentedCategories}</p>
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-[#64748B] mt-2 max-w-xl mx-auto">
              Area program yang muncul dalam arsip digital Allman. Jumlah kategori di bawah adalah konteks registry internal, bukan klaim dampak.
            </p>
          </div>
            ...
            {legacyServiceCatalog.map((svc, idx) => (
              <div key={idx} className="bg-white rounded-2xl p-5 hover:shadow-md transition-shadow" style={{ border: '1.5px solid rgb(240, 217, 200)' }}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-[#94A3B8]">Arsip Allman</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-[#64748B] mt-2 max-w-xl mx-auto">
              Hanya entri dengan tautan bukti publik yang unik dan tidak berkonflik yang ditampilkan.
            </p>
          </div>

          <PortfolioExplorer cards={publicPortfolioCards} />
        </Container>
      </section>
