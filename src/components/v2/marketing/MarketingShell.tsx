...
// Landing-page design shell for marketing sub-pages: Manrope + dark canvas +
...
export function MarketingShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`${manrope.className} min-h-screen text-[#0F172A] antialiased`} style={{ background: "rgb(13, 16, 28)" }}>
      <style>{`
