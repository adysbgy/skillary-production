...
export const BeasiswaSection = () => {
  return (
    <section className="py-16 md:py-20 lg:py-24 overflow-hidden" style={{'background': 'rgb(255, 251, 245)'}}>
      {/* Heading — inside container, aligned to the grid */}
      <div className="max-w-7xl mx-auto px-5 md:px-6 lg:px-8">
        <div className="flex items-center gap-3 mb-8 md:mb-10">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{'background': 'rgb(255, 244, 232)'}}>
      ...
      {/* Card row — uses outer container for alignment + right fade for overflow */}
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="flex gap-4 md:gap-5 lg:gap-6 overflow-x-auto hide-scrollbar pb-4 pt-1 px-5 md:px-6 lg:px-8">

          {/* Card 1: In-House Training */}
          <div className="flex-shrink-0 w-[260px] md:w-[280px] lg:w-[300px] bg-white rounded-2xl overflow-hidden card-hover flex flex-col" style={{'border': '1.5px solid rgb(240, 217, 200)', 'boxShadow': 'rgba(0, 0, 0, 0.06) 0px 1px 4px'}}>
            ...
            <div className="p-4 flex flex-col flex-1">
              ...
              <p className="text-[10px] text-skillary-muted mb-3 flex-1">
                Program pelatihan untuk kebutuhan internal organisasi.
              </p>
              <Link href="/contact" className="w-full flex items-center justify-center gap-1.5 text-xs font-bold py-2.5 rounded-xl transition-all hover:opacity-90 mt-auto" style={{'background': 'rgb(255, 244, 232)', 'color': 'rgb(255, 138, 0)', 'border': '1.5px solid rgb(255, 214, 165)'}}>
                Diskusikan Solusi
