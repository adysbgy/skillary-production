...
<div className="relative rounded-3xl overflow-hidden shadow-banner" style={{'background': 'linear-gradient(135deg, rgb(255, 138, 0) 0%, rgb(255, 90, 95) 55%, rgb(236, 72, 153) 100%)'}}>
