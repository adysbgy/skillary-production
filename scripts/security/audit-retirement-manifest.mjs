...
for(const item of manifest.protectedDependencies){if(!["KEEP_DEPENDENCY","KEEP_PENDING_REVIEW"].includes(item.decision))throw new Error(`Dependency protection incomplete: ${item.route}`)}
