...
const matrix={"/v2/events/:slug/checkout":"/events/:slug/checkout","/v2/events/:slug":"/events/:slug","/v2/events":"/events","/v2/program/:slug":"/programs/:slug","/v2/catalog":"/programs","/v2/untuk-organisasi":"/untuk-organisasi","/v2/about":"/about","/v2/resources":"/resources","/v2/proposal":"/contact","/v2/portfolio":"/portofolio","/proposal":"/contact","/program-catalog":"/programs","/training-brief":"/contact"};
