...
const canonicals={"src/app/blog/[slug]/page.tsx":"`/blog/${post.slug}`","src/app/program/[id]/page.tsx":"`/program/${program.slug}`","src/app/v2/events/[slug]/page.tsx":"`/v2/events/${event.slug}`","src/app/path/[slug]/page.tsx":"`/path/${path.slug}`","src/app/trainers/[slug]/page.tsx":"`/trainers/${t.slug}`"};
